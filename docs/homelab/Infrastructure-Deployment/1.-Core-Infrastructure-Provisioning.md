...
*📅 Published: 2026-05-04 13:14 | 🔄 Last Updated: 2026-05-30 10:53*
<!-- notion-metadata-end -->
---
...
- _Enter the Optional 1 interface name..._ type **em2** and hit **Enter**. (This interface serves as SIEM Zone).
...
7. _Do you want to enable the DHCP server on LAN?_ Type **y** and hit **Enter**. (This allows pfSense to lease IP addresses to Windows machines).
8. _Start address:_ Type **10.10.10.100** and hit **Enter**.
9. _End address:_ Type **10.10.10.200** and hit **Enter**. (IP allocation to avoid ip conflict with static ip range)
10. _Do you want to revert to HTTP..._ Type **n** and hit **Enter**.

**Host Machine Configuration Adjustment:**
Return to physical host machine and run the `ipconfig` command.
...
The resutl - all firewall interfaces are configured as below:


![](./3567b0eb-61a4-8024-9121-fcefd793cbdf.3707b0eb-61a4-8024-bca6-e367b6f96613.png)
...
1. Open **Server Manager**, navigate to **Tools**, and select **Active Directory Users and Computers (ADUC)**.
	...
	![](./3567b0eb-61a4-8024-9121-fcefd793cbdf.3707b0eb-61a4-80b5-9f6d-e68c9f08d085.png)
...
4. In the Network ID field, enter subnet: **10.10.10**. Click Next.
